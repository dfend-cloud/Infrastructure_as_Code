...
# azuread_conditional_access_policy.sbca02:
resource "azuread_conditional_access_policy" "sbca02" {
    display_name = "SBCA02: All-Apps-All-Users-Require-MFA-Exclude-Administrators-and-Trusted-Locations"
    state        = "disabled"
